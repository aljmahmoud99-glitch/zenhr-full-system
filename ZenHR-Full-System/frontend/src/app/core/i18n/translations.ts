export const T = {
  nav: {
    ...
    holidays:     { ar: 'الأعياد',      en: 'Public Holidays' },
    ...
    forms:        { ar: 'النماذج',      en: 'Official Forms' },
  ...
  status: {
    ...
    expiringSoon: { ar: 'ينتهي قريباً',  en: 'Expiring Soon' },
  ...
  employee: {
    ...
    nationalId:   { ar: 'رقم الوطني',    en: 'National ID' },
  ...
  payroll: {
    ...
    ssc:         { ar: 'ضمان اجتماعي',   en: 'Social Security' },
